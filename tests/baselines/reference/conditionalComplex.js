...
//// [conditionalComplex.js]
var a = isSquare({ kind: "circle", radius: 12 });
var b = isSquare({ kind: "square", side: 12 });
var c = isSquare(Math.random() > 0.5 ? { kind: "circle", radius: 12 } : { kind: "square", side: 12 });
var d = objHasField("x");
var e = objHasField("z");
