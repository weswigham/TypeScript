...
var NumLiteral;
(function (NumLiteral) {
    NumLiteral[NumLiteral["Val"] = 0] = "Val";
})(NumLiteral || (NumLiteral = {}));
function f1(notString, str, strlit, strenum, num, numlit, numenum, unknownVal, neverVal) {
    notString = str; // not ok
    notString = strlit; // not ok
    notString = strenum; // not ok
    notString = num; // ok
...
function f2(x, y, xy, nx, ny, nxy, neither, notBoth) {
    x = y; // not ok
    x = xy; // ok
    x = nx; // not ok
    x = ny; // not ok
