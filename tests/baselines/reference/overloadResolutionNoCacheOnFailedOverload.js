//// [overloadResolutionNoCacheOnFailedOverload.ts]
...
//// [overloadResolutionNoCacheOnFailedOverload.js]
var machine = {};
var ret = useMachine(machine, {
    action: assign(function (_ev) {
        (function (_type) { return null; })(_ev.type);
    })
});
