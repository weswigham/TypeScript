...
/* @internal */
function getInfo(sourceFile: ts.SourceFile, pos: number, checker: ts.TypeChecker): {
...
/* @internal */
type TypeContainer = ts.AsExpression | ts.CallSignatureDeclaration | ts.ConstructSignatureDeclaration | ts.FunctionDeclaration | ts.GetAccessorDeclaration | ts.IndexSignatureDeclaration | ts.MappedTypeNode | ts.MethodDeclaration | ts.MethodSignature | ts.ParameterDeclaration | ts.PropertyDeclaration | ts.PropertySignature | ts.SetAccessorDeclaration | ts.TypeAliasDeclaration | ts.TypeAssertion | ts.VariableDeclaration;
/* @internal */
