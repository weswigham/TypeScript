...
/* @internal */
function getQualifiedName(sourceFile: ts.SourceFile, pos: number): (ts.QualifiedName & {
    left: ts.Identifier;
}) | undefined {
    ...
    return ts.isIdentifier(qualifiedName.left) ? qualifiedName as ts.QualifiedName & {
        left: ts.Identifier;
    } : undefined;
}
/* @internal */
