...
export function getAllRules(): RuleSpec[] {
    ...
    const highPriorityCommonRules = [
        ...
        rule("NoSpaceBeforeQuestionMark", anyToken, ts.SyntaxKind.QuestionToken, [isNonJsxSameLineTokenContext, isNotBinaryOpContext], ts.formatting.RuleAction.DeleteSpace),
        ...
        rule("NoSpaceBeforeDot", anyToken, [ts.SyntaxKind.DotToken, ts.SyntaxKind.QuestionDotToken], [isNonJsxSameLineTokenContext], ts.formatting.RuleAction.DeleteSpace),
        ...
        rule("NoSpaceBeforeUnaryPostincrementOperator", unaryPostincrementExpressions, ts.SyntaxKind.PlusPlusToken, [isNonJsxSameLineTokenContext], ts.formatting.RuleAction.DeleteSpace),
        rule("NoSpaceBeforeUnaryPostdecrementOperator", unaryPostdecrementExpressions, ts.SyntaxKind.MinusMinusToken, [isNonJsxSameLineTokenContext], ts.formatting.RuleAction.DeleteSpace),
        ...
        rule("SpaceBetweenAsyncAndFunctionKeyword", ts.SyntaxKind.AsyncKeyword, ts.SyntaxKind.FunctionKeyword, [isNonJsxSameLineTokenContext], ts.formatting.RuleAction.InsertSpace),
        // Template string
        ...
        ], anyToken, [isNonJsxSameLineTokenContext], ts.formatting.RuleAction.InsertSpace),
        rule("SpaceBeforeCertainTypeScriptKeywords", anyToken, [ts.SyntaxKind.ExtendsKeyword, ts.SyntaxKind.ImplementsKeyword, ts.SyntaxKind.FromKeyword], [isNonJsxSameLineTokenContext], ts.formatting.RuleAction.InsertSpace),
        ...
        ], [isEndOfDecoratorContextOnSameLine], ts.formatting.RuleAction.InsertSpace),
    ...
    const userConfigurableRules = [
        ...
        rule("SpaceAfterComma", ts.SyntaxKind.CommaToken, anyToken, [isOptionEnabled("insertSpaceAfterCommaDelimiter"), isNonJsxSameLineTokenContext, isNonJsxElementOrFragmentContext, isNextTokenNotCloseBracket], ts.formatting.RuleAction.InsertSpace),
        ...
        rule("SpaceAfterTemplateHeadAndMiddle", [ts.SyntaxKind.TemplateHead, ts.SyntaxKind.TemplateMiddle], anyToken, [isOptionEnabled("insertSpaceAfterOpeningAndBeforeClosingTemplateStringBraces"), isNonJsxSameLineTokenContext], ts.formatting.RuleAction.InsertSpace),
        ...
        rule("NoSpaceAfterTemplateHeadAndMiddle", [ts.SyntaxKind.TemplateHead, ts.SyntaxKind.TemplateMiddle], anyToken, [isOptionDisabledOrUndefined("insertSpaceAfterOpeningAndBeforeClosingTemplateStringBraces"), isNonJsxSameLineTokenContext], ts.formatting.RuleAction.DeleteSpace),
        ...
        rule("SpaceBeforeTypeAnnotation", anyToken, ts.SyntaxKind.ColonToken, [isOptionEnabled("insertSpaceBeforeTypeAnnotation"), isNonJsxSameLineTokenContext, isTypeAnnotationContext], ts.formatting.RuleAction.InsertSpace),
        rule("NoSpaceBeforeTypeAnnotation", anyToken, ts.SyntaxKind.ColonToken, [isOptionDisabledOrUndefined("insertSpaceBeforeTypeAnnotation"), isNonJsxSameLineTokenContext, isTypeAnnotationContext], ts.formatting.RuleAction.DeleteSpace),
    ...
    const lowPriorityCommonRules = [
        ...
        rule("SpaceBetweenStatements", [ts.SyntaxKind.CloseParenToken, ts.SyntaxKind.DoKeyword, ts.SyntaxKind.ElseKeyword, ts.SyntaxKind.CaseKeyword], anyToken, [isNonJsxSameLineTokenContext, isNonJsxElementOrFragmentContext, isNotForContext], ts.formatting.RuleAction.InsertSpace),
        // This low-pri rule takes care of "try {" and "finally {" in case the rule SpaceBeforeOpenBraceInControl didn't execute on FormatOnEnter.
        rule("SpaceAfterTryFinally", [ts.SyntaxKind.TryKeyword, ts.SyntaxKind.FinallyKeyword], ts.SyntaxKind.OpenBraceToken, [isNonJsxSameLineTokenContext], ts.formatting.RuleAction.InsertSpace),
    ];
    return [
...
function isYieldOrYieldStarWithOperand(context: ts.formatting.FormattingContext): boolean {
    return context.contextNode.kind === ts.SyntaxKind.YieldExpression && (<ts.YieldExpression>context.contextNode).expression !== undefined;
}
/* @internal */
...
function isSemicolonDeletionContext(context: ts.formatting.FormattingContext): boolean {
    ...
    if (ts.isTrivia(nextTokenKind)) {
        const nextRealToken = context.nextTokenParent === context.currentTokenParent
            ? ts.findNextToken(context.currentTokenParent, (ts.findAncestor(context.currentTokenParent, a => !a.parent)!), context.sourceFile)
