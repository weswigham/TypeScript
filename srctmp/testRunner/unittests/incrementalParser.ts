...
function withChange(text: ts.IScriptSnapshot, start: number, length: number, newText: string): {
...
function withInsert(text: ts.IScriptSnapshot, start: number, newText: string): {
    text: ts.IScriptSnapshot;
    textChangeRange: ts.TextChangeRange;
} {
    return withChange(text, start, 0, newText);
}
function withDelete(text: ts.IScriptSnapshot, start: number, length: number): {
    text: ts.IScriptSnapshot;
    textChangeRange: ts.TextChangeRange;
} {
