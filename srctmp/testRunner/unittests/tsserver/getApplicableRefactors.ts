...
describe("unittests:: tsserver:: getApplicableRefactors", () => {
    it("works when taking position", () => {
        ...
        const response = ts.projectSystem.executeSessionRequest<ts.projectSystem.protocol.GetApplicableRefactorsRequest, ts.projectSystem.protocol.GetApplicableRefactorsResponse>(session, ts.projectSystem.protocol.CommandTypes.GetApplicableRefactors, { file: aTs.path, line: 1, offset: 1 });
