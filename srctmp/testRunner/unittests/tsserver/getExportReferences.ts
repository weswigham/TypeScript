...
`,
    ...
    const referenceMainTs = (mainTs: ts.projectSystem.File, text: string): ts.projectSystem.protocol.ReferencesResponseItem => ts.projectSystem.makeReferenceItem({
        file: mainTs,
        isDefinition: true,
    ...
    const referenceModTs = (texts: {
        ...
        lineText: string;
        contextText?: string;
    }, override: Partial<ts.projectSystem.MakeReferenceItem> = {}): ts.projectSystem.protocol.ReferencesResponseItem => ts.projectSystem.makeReferenceItem({
        file: modTs,
        isDefinition: true,
        ...texts,
        ...override,
    ...
    it("should get const variable declaration references", () => {
        ...
        const response = ts.projectSystem.executeSessionRequest<ts.projectSystem.protocol.ReferencesRequest, ts.projectSystem.protocol.ReferencesResponse>(session, ts.projectSystem.protocol.CommandTypes.References, ts.projectSystem.protocolFileLocationFromSubstring(modTs, "value"));
    ...
    it("should get array destructuring declaration references", () => {
        const session = makeSampleSession();
        const response = ts.projectSystem.executeSessionRequest<ts.projectSystem.protocol.ReferencesRequest, ts.projectSystem.protocol.ReferencesResponse>(session, ts.projectSystem.protocol.CommandTypes.References, ts.projectSystem.protocolFileLocationFromSubstring(modTs, "valueA"));
        const expectResponse = {
            refs: [
                referenceModTs({
                    text: "valueA",
    ...
    it("should get object destructuring declaration references", () => {
        const session = makeSampleSession();
        const response = ts.projectSystem.executeSessionRequest<ts.projectSystem.protocol.ReferencesRequest, ts.projectSystem.protocol.ReferencesResponse>(session, ts.projectSystem.protocol.CommandTypes.References, ts.projectSystem.protocolFileLocationFromSubstring(modTs, "valueC"));
        const expectResponse = {
            refs: [
                referenceModTs({
                    text: "valueC",
    ...
    it("should get object declaration references that renames destructured property", () => {
        const session = makeSampleSession();
        const response = ts.projectSystem.executeSessionRequest<ts.projectSystem.protocol.ReferencesRequest, ts.projectSystem.protocol.ReferencesResponse>(session, ts.projectSystem.protocol.CommandTypes.References, ts.projectSystem.protocolFileLocationFromSubstring(modTs, "renamedD"));
        const expectResponse = {
            refs: [
                referenceModTs({
                    text: "renamedD",
    ...
    it("should get nested object declaration references", () => {
        const session = makeSampleSession();
        const response = ts.projectSystem.executeSessionRequest<ts.projectSystem.protocol.ReferencesRequest, ts.projectSystem.protocol.ReferencesResponse>(session, ts.projectSystem.protocol.CommandTypes.References, ts.projectSystem.protocolFileLocationFromSubstring(modTs, "valueF"));
        const expectResponse = {
            refs: [
                referenceModTs({
                    text: "valueF",
