...
describe("unittests:: config:: tsconfigParsing:: parseConfigFileTextToJson", () => {
    ...
    it("generates errors for empty files list", () => {
        ...
        assertParseFileDiagnostics(content, "/apath/tsconfig.json", "tests/cases/unittests", ["/apath/a.ts"], ts.Diagnostics.The_files_list_in_config_file_0_is_empty.code);
    });
    ...
    it("does not generate errors for empty files list when one or more references are provided", () => {
        ...
        assertParseFileDiagnosticsExclusion(content, "/apath/tsconfig.json", "tests/cases/unittests", ["/apath/a.ts"], ts.Diagnostics.The_files_list_in_config_file_0_is_empty.code);
    });
    it("generates errors for directory with no .ts files", () => {
        const content = `{
            }`;
        assertParseFileDiagnostics(content, "/apath/tsconfig.json", "tests/cases/unittests", ["/apath/a.js"], ts.Diagnostics.No_inputs_were_found_in_config_file_0_Specified_include_paths_were_1_and_exclude_paths_were_2.code, 
        /*noLocation*/ true);
    });
    it("generates errors for empty directory", () => {
        ...
        assertParseFileDiagnostics(content, "/apath/tsconfig.json", "tests/cases/unittests", [], ts.Diagnostics.No_inputs_were_found_in_config_file_0_Specified_include_paths_were_1_and_exclude_paths_were_2.code, 
        /*noLocation*/ true);
    });
    it("generates errors for empty include", () => {
        ...
        assertParseFileDiagnostics(content, "/apath/tsconfig.json", "tests/cases/unittests", ["/apath/a.ts"], ts.Diagnostics.No_inputs_were_found_in_config_file_0_Specified_include_paths_were_1_and_exclude_paths_were_2.code, 
        /*noLocation*/ true);
    });
