import { Symbol, TypeChecker, forEach, LanguageServiceHost, Program, SourceFile, UserPreferences, CompletionsTriggerCharacter, CompletionInfo, findPrecedingToken, isInString, isBreakOrContinueStatement, SyntaxKind, Debug, CompletionEntry, CompilerOptions, isJsxClosingElement, findChildOfKind, ScriptElementKind, arrayToSet, isSourceFileJS, isCheckJsEnabledForFile, ScriptTarget, Push, getNameTable, unescapeLeadingUnderscores, addToSeen, isIdentifierText, PseudoBigInt, pseudoBigIntToString, isString, quote, ScriptElementKindModifier, Node, PropertyAccessExpression, TextSpan, startsWith, createTextSpanFromBounds, createTextSpanFromNode, positionIsASICandidate, SymbolFlags, stripQuotes, timestamp, createMap, getSymbolId, some, BreakOrContinueStatement, isFunctionLike, isLabeledStatement, find, firstDefined, CancellationToken, CompletionEntryDetails, SymbolDisplayPartKind, displayPart, CodeAction, SymbolDisplayPart, SemanticMeaning, JSDocTagInfo, skipAlias, getNameForExportedSymbol, isIdentifier, textPart, Identifier, JSDocParameterTag, Type, isAbstractConstructorSymbol, getContextualTypeFromParent, VariableDeclaration, BinaryExpression, JsxAttribute, Expression, getSwitchedType, cast, isCaseClause, isJsxExpression, isEqualityOperatorKind, isBinaryExpression, first, getTokenAtPosition, isInComment, hasDocComment, CharacterCodes, getLineStartPositionForPosition, isDeclarationName, JSDocPropertyTag, isJSDocParameterTag, nodeIsMissing, isIdentifierOrPrivateIdentifier, isKeyword, getTouchingPropertyName, isCallExpression, last, QualifiedName, ModuleDeclaration, LanguageVariant, JsxElement, mapDefined, JSDocReturnTag, JSDocTypeTag, JSDocTypedefTag, JSDocTag, isLiteralImportTypeNode, ImportTypeNode, isPartOfTypeNode, isPossiblyTypeArgumentPosition, isInRightSideOfInternalImportEqualsDeclaration, isEntityName, isModuleDeclaration, NodeFlags, isMetaProperty, escapeLeadingUnderscores, tryCast, getNameOfDeclaration, isComputedPropertyName, isExternalModuleSymbol, isPropertyAccessExpression, ContextFlags, compilerOptionsIndicateEs6Modules, programContainsEs6Modules, isStatement, filterMutate, isSourceFile, isExportAssignment, getCombinedLocalAndExportSymbolFlags, isAssertionExpression, isTypeOfExpression, isFunctionLikeKind, every, findAncestor, isGlobalScopeAugmentation, isExportSpecifier, isIdentifierANonContextualKeyword, InternalSymbolName, getLocalSymbolForExportDefault, positionBelongsToNode, isRegularExpressionLiteral, isStringTextContainingNode, rangeContainsPositionExclusive, createTextRangeFromSpan, Declaration, hasIndexSignature, getRootDeclaration, isVariableLike, hasInitializer, hasType, isExpression, getContainingClass, getDeclarationModifierFlagsFromSymbol, ModifierFlags, contains, isNamedImportsOrExports, ImportOrExportSpecifier, isClassLike, isClassElement, getModifierFlags, flatMap, getAllSuperTypeNodes, ObjectLiteralExpression, ObjectBindingPattern, isObjectLiteralExpression, isObjectBindingPattern, isMethodDeclaration, isShorthandPropertyAssignment, isParameter, isConstructorDeclaration, isParameterPropertyModifier, ConstructorDeclaration, FunctionLikeDeclaration, isFunctionLikeDeclaration, JsxOpeningLikeElement, isPropertyDeclaration, isJsxAttribute, createUnderscoreEscapedMap, __String, isSpreadAssignment, isBindingElement, isPropertyNameLiteral, getEscapedTextOfIdentifierOrLiteral, SpreadAssignment, JsxSpreadAttribute, ObjectType, ClassElement, hasModifier, getPropertyNameForPropertyNameNode, NodeArray, isJsxSpreadAttribute, isSingleOrDoubleQuote, isKnownSymbol, isPrivateIdentifierPropertyDeclaration, memoize, tokenToString, stringToToken, isTypeKeyword, isClassMemberModifier, isContextualKeyword, isJSDoc, rangeContainsPosition, findLast, JsxAttributes, TypeFlags, typeHasCallOrConstructSignatures, ObjectTypeDeclaration, isObjectTypeDeclaration, lastOrUndefined, TypeElement, getLineAndCharacterOfPosition, isClassOrTypeElement, isStringLiteralOrTemplate, isPrivateIdentifier, isStringLiteralLike, tryGetImportFromModuleSpecifier } from "./ts";
import { getStringLiteralCompletions, getStringLiteralCompletionDetails } from "./ts.Completions.StringCompletions";
import { getJSDocTagNameCompletions, getJSDocTagCompletions, getJSDocParameterNameCompletions, getJSDocTagNameCompletionDetails, getJSDocTagCompletionDetails, getJSDocParameterNameCompletionDetails } from "./ts.JsDoc";
import { getSymbolKind, getSymbolModifiers, getSymbolDisplayPartsDocumentationAndSymbolKind } from "./ts.SymbolDisplay";
import { FormatContext } from "./ts.formatting";
import { getImportCompletionAction, forEachExternalModuleToImportFrom } from "./ts.codefix";
import { getArgumentInfoForCompletions } from "./ts.SignatureHelp";
...
export function getCompletionsAtPosition(host: LanguageServiceHost, program: Program, log: Log, sourceFile: SourceFile, position: number, preferences: UserPreferences, triggerCharacter: CompletionsTriggerCharacter | undefined): CompletionInfo | undefined {
    ...
    const stringCompletions = getStringLiteralCompletions(sourceFile, position, contextToken, typeChecker, compilerOptions, host, log, preferences);
...
/* @internal */
function getJSCompletionEntries(sourceFile: SourceFile, position: number, uniqueNames: ts.Map<true>, target: ScriptTarget, entries: Push<CompletionEntry>): void {
...
export function getCompletionEntriesFromSymbols(symbols: readonly Symbol[], entries: Push<CompletionEntry>, location: Node | undefined, sourceFile: SourceFile, typeChecker: TypeChecker, target: ScriptTarget, log: Log, kind: CompletionKind, preferences: UserPreferences, propertyAccessToConvert?: PropertyAccessExpression, isJsxInitializer?: IsJsxInitializer, recommendedCompletion?: Symbol, symbolToOriginInfoMap?: SymbolOriginInfoMap, symbolToSortTextMap?: SymbolSortTextMap): ts.Map<true> {
    ...
    for (const symbol of symbols) {
        ...
        const entry = createCompletionEntry(symbol, symbolToSortTextMap && symbolToSortTextMap[getSymbolId(symbol)] || SortText.LocationPriority, location, sourceFile, typeChecker, name, needsConvertPropertyAccess, origin, recommendedCompletion, propertyAccessToConvert, isJsxInitializer, preferences);
        if (!entry) {
            continue;
        }
...
/* @internal */
function getSymbolCompletionFromEntryId(program: Program, log: Log, sourceFile: SourceFile, position: number, entryId: CompletionEntryIdentifier, host: LanguageServiceHost, preferences: UserPreferences): SymbolCompletion | {
    type: "request";
    request: Request;
} | {
    type: "literal";
...
/* @internal */
export function getCompletionEntryDetails(program: Program, log: Log, sourceFile: SourceFile, position: number, entryId: CompletionEntryIdentifier, host: LanguageServiceHost, formatContext: FormatContext, preferences: UserPreferences, cancellationToken: CancellationToken): CompletionEntryDetails | undefined {
    const typeChecker = program.getTypeChecker();
    const compilerOptions = program.getCompilerOptions();
    const { name } = entryId;
    const contextToken = findPrecedingToken(position, sourceFile);
    if (isInString(sourceFile, position, contextToken)) {
        return getStringLiteralCompletionDetails(name, sourceFile, position, contextToken, typeChecker, compilerOptions, host, cancellationToken);
    }
...
export function createCompletionDetailsForSymbol(symbol: Symbol, checker: TypeChecker, sourceFile: SourceFile, location: Node, cancellationToken: CancellationToken, codeActions?: CodeAction[], sourceDisplay?: SymbolDisplayPart[]): CompletionEntryDetails {
    const { displayParts, documentation, symbolKind, tags } = checker.runWithCancellationToken(cancellationToken, checker => getSymbolDisplayPartsDocumentationAndSymbolKind(checker, symbol, sourceFile, location, location, SemanticMeaning.All));
...
/* @internal */
function getCompletionEntryCodeActionsAndSourceDisplay(symbolToOriginInfoMap: SymbolOriginInfoMap, symbol: Symbol, program: Program, checker: TypeChecker, host: LanguageServiceHost, compilerOptions: CompilerOptions, sourceFile: SourceFile, position: number, previousToken: Node | undefined, formatContext: FormatContext, preferences: UserPreferences): CodeActionsAndSourceDisplay {
    ...
    const { moduleSpecifier, codeAction } = getImportCompletionAction(exportedSymbol, moduleSymbol, sourceFile, getNameForExportedSymbol(symbol, (compilerOptions.target!)), host, program, formatContext, previousToken && isIdentifier(previousToken) ? previousToken.getStart(sourceFile) : position, preferences);
...
/* @internal */
function getCompletionData(program: Program, log: (message: string) => void, sourceFile: SourceFile, isUncheckedFile: boolean, position: number, preferences: Pick<UserPreferences, "includeCompletionsForModuleExports" | "includeCompletionsWithInsertText" | "includeAutomaticOptionalChainCompletions">, detailsEntryId: CompletionEntryIdentifier | undefined, host: LanguageServiceHost): CompletionData | Request | undefined {
    const typeChecker = program.getTypeChecker();
    let start = timestamp();
    ...
    function shouldOfferImportCompletions(): boolean {
        ...
        if (compilerOptionsIndicateEs6Modules(program.getCompilerOptions()))
            return true;
    ...
    function getSymbolsFromOtherSourceFileExports(target: ScriptTarget, host: LanguageServiceHost): readonly AutoImportSuggestion[] {
        ...
        /** Bucket C */
        const aliasesToReturnIfOriginalsAreMissing = createMap<{
            alias: Symbol;
            moduleSymbol: Symbol;
        }>();
        /** Bucket A */
        ...
        forEachExternalModuleToImportFrom(program, host, sourceFile, !detailsEntryId, moduleSymbol => {
    ...
    function isInStringOrRegularExpressionOrTemplateLiteral(contextToken: Node): boolean {
        ...
        return (isRegularExpressionLiteral(contextToken) || isStringTextContainingNode(contextToken)) && (rangeContainsPositionExclusive(createTextRangeFromSpan(createTextSpanFromNode(contextToken)), position) ||
                ...
                case SyntaxKind.JsxSpreadAttribute:
                    if (parent && (parent.kind === SyntaxKind.JsxSelfClosingElement || parent.kind === SyntaxKind.JsxOpeningElement)) {
                        if (contextToken.kind === SyntaxKind.GreaterThanToken) {
                            ...
                            if (!(parent as JsxOpeningLikeElement).typeArguments || (precedingToken && precedingToken.kind === SyntaxKind.SlashToken))
                                break;
                        }
    ...
    function setMembersDeclaredBySpreadAssignment(declaration: SpreadAssignment | JsxSpreadAttribute, membersDeclaredBySpreadAssignment: ts.Map<true>) {
    ...
    function setSortTextToMemberDeclaredBySpreadAssignment(membersDeclaredBySpreadAssignment: ts.Map<true>, contextualMemberSymbols: Symbol[]): void {
...
/* @internal */
function getCompletionEntryDisplayNameForSymbol(symbol: Symbol, target: ScriptTarget, origin: SymbolOriginInfo | undefined, kind: CompletionKind): CompletionEntryDisplayNameForSymbol | undefined {
