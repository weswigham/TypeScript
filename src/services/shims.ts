...
namespace ts {
    interface DiscoverTypingsInfo {
        ...
        packageNameToTypingLocation: ts.Map<ts.JsTyping.CachedTyping>; // The map of package names to their cached typing locations and installed versions
        ...
        typesRegistry: ts.ReadonlyMap<ts.MapLike<string>>; // The map of available typings in npm to maps of TS versions to their latest supported versions
    }
    ...
    export interface LanguageServiceShim extends Shim {
        ...
        getCompletionsAtPosition(fileName: string, position: number, preferences: ts.UserPreferences | undefined): string;
        getCompletionEntryDetails(fileName: string, position: number, entryName: string, formatOptions: string /*Services.FormatCodeOptions*/ | undefined, source: string | undefined, preferences: ts.UserPreferences | undefined): string;
         ...
         */
        getRenameInfo(fileName: string, position: number, options?: ts.RenameInfoOptions): string;
    ...
    export class LanguageServiceShimHostAdapter implements ts.LanguageServiceHost {
        ...
        public resolveTypeReferenceDirectives: ((typeDirectiveNames: string[], containingFile: string) => (ts.ResolvedTypeReferenceDirective | undefined)[]) | undefined;
        ...
        constructor(private shimHost: LanguageServiceShimHost) {
            ...
            if ("getModuleResolutionsForFile" in this.shimHost) {
                this.resolveModuleNames = (moduleNames, containingFile) => {
                    const resolutionsInFile = (<ts.MapLike<string>>JSON.parse(this.shimHost.getModuleResolutionsForFile!(containingFile))); // TODO: GH#18217
            ...
            if ("getTypeReferenceDirectiveResolutionsForFile" in this.shimHost) {
                this.resolveTypeReferenceDirectives = (typeDirectiveNames, containingFile) => {
                    const typeDirectivesForFile = (<ts.MapLike<ts.ResolvedTypeReferenceDirective>>JSON.parse(this.shimHost.getTypeReferenceDirectiveResolutionsForFile!(containingFile))); // TODO: GH#18217
        ...
        public getCompilationSettings(): ts.CompilerOptions {
            ...
            const compilerOptions = (<ts.CompilerOptions>JSON.parse(settingsJson));
        ...
        public readDirectory(path: string, extensions?: readonly string[], exclude?: string[], include?: string[], depth?: number): string[] {
            const pattern = ts.getFileMatcherPatterns(path, exclude, include, this.shimHost.useCaseSensitiveFileNames!(), this.shimHost.getCurrentDirectory()); // TODO: GH#18217
    ...
    export class CoreServicesShimHostAdapter implements ts.ParseConfigHost, ts.ModuleResolutionHost, ts.JsTyping.TypingResolutionHost {
        ...
        public readDirectory(rootDir: string, extensions: readonly string[], exclude: readonly string[], include: readonly string[], depth?: number): string[] {
            const pattern = ts.getFileMatcherPatterns(rootDir, exclude, include, this.shimHost.useCaseSensitiveFileNames!(), this.shimHost.getCurrentDirectory()); // TODO: GH#18217
    ...
    class LanguageServiceShimObject extends ShimBase implements LanguageServiceShim {
        ...
        constructor(factory: ShimFactory, private host: LanguageServiceShimHost, public languageService: ts.LanguageService) {
            super(factory);
        ...
        private realizeDiagnostics(diagnostics: readonly ts.Diagnostic[]): {
            message: string;
            start: number;
            length: number;
            category: string;
        ...
        public getRenameInfo(fileName: string, position: number, options?: ts.RenameInfoOptions): string {
         ...
         * list if requested.
         */
        public getCompletionsAtPosition(fileName: string, position: number, preferences: ts.GetCompletionsAtPositionOptions | undefined) {
        ...
        public getCompletionEntryDetails(fileName: string, position: number, entryName: string, formatOptions: string /*Services.FormatCodeOptions*/ | undefined, source: string | undefined, preferences: ts.UserPreferences | undefined) {
        ...
        public getEmitOutputObject(fileName: string): ts.EmitOutput {
            ...
            /*returnJson*/ false, () => this.languageService.getEmitOutput(fileName), this.logPerformance) as ts.EmitOutput;
        }
    }
    function convertClassifications(classifications: ts.Classifications): {
        spans: string;
    ...
    class CoreServicesShimObject extends ShimBase implements CoreServicesShim {
        ...
        public resolveModuleName(fileName: string, moduleName: string, compilerOptionsJson: string): string {
            return this.forwardJSONCall(`resolveModuleName('${fileName}')`, () => {
                const compilerOptions = (<ts.CompilerOptions>JSON.parse(compilerOptionsJson));
