import { projectRoot, createSolutionBuilder } from "../../ts.tscWatch";
import { File, createServerHost, libFile, createSession, openFilesForSession, protocol, protocolToLocation } from "../../ts.projectSystem";
import { TestFSWithWatch, EmitOutput, emptyArray, changeExtension } from "../../ts";
...
describe("unittests:: tsserver:: with project references and compile on save with external projects", () => {
    ...
    export class Sibling {
        ...
        const solutionBuilder = createSolutionBuilder(host, [siblingConfig.path], {});
