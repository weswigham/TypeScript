import {getModuleInstanceState, ModuleInstanceState, bindSourceFile} from "./binder";
import {forEachChild} from "./parser";
import {
    Node, Symbol, TypeCheckerHost,
    TypeChecker, CancellationToken, SymbolTable,
    ScriptTarget, SymbolFlags, TypeFlags,
    GenericType, ObjectType, SymbolLinks,
    NodeLinks, Map, Type,
    TupleType, UnionType, IntersectionType,
    StringLiteralType, Signature, RelationComparisonResult,
    SymbolDisplayBuilder, SourceFile, DiagnosticMessage,
    SyntaxKind, TransientSymbol, FunctionLikeDeclaration,
    ModuleDeclaration, NodeFlags, ClassExpression,
    ClassLikeDeclaration, Identifier, ArrayTypeNode,
    InterfaceType, FunctionExpression, VariableDeclaration,
    PropertyDeclaration, ForInStatement, ForOfStatement,
    AnyImportSyntax, ImportDeclaration, ImportEqualsDeclaration,
    EntityName, Declaration, ImportClause,
    ExportAssignment, ExportSpecifier, QualifiedName,
    NamespaceImport, LiteralExpression, ResolvedType,
    ResolvedModule, Expression, ImportOrExportSpecifier,
    ExportDeclaration, ImportSpecifier, NamedImports,
    NamedImportsOrExports, ConstructorDeclaration, IntrinsicType,
    PropertyAccessExpression, CharacterCodes, SymbolAccessiblityResult,
    SymbolAccessibility, SymbolVisibilityResult, SymbolWriter,
    TypeFormatFlags, SymbolFormatFlags, TypeReference,
    UnionOrIntersectionType, IndexKind, SignatureDeclaration,
    TextRange, SignatureKind, TypeParameter,
    ParameterDeclaration, TypeMapper, BindingPattern,
    BindingElement, VariableLikeDeclaration, AccessorDeclaration,
    TypeParameterDeclaration, InterfaceDeclaration, TypeAliasDeclaration,
    ExpressionWithTypeArguments, TypeNode, InterfaceTypeWithDeclaredMembers,
    TypePredicate, ClassDeclaration, TypePredicateNode,
    TypeReferenceNode, TypeQueryNode, TupleTypeNode,
    UnionTypeNode, IntersectionTypeNode, StringLiteral,
    ParenthesizedTypeNode, InferenceContext, MethodDeclaration,
    ObjectLiteralElement, ObjectLiteralExpression, ArrayLiteralExpression,
    ConditionalExpression, BinaryExpression, PropertyAssignment,
    ParenthesizedExpression, DiagnosticMessageChain, FreshObjectLiteralType,
    TypeInferences, IfStatement, TypeOfExpression,
    CallExpression, PrefixUnaryExpression, ParserContextFlags,
    NodeCheckFlags, YieldExpression, CallLikeExpression,
    TemplateExpression, TaggedTemplateExpression, JsxExpression,
    JsxSpreadAttribute, JsxAttribute, JsxOpeningLikeElement,
    AssertionExpression, SpreadElementExpression, DeclarationName,
    ComputedPropertyName, ShorthandPropertyAssignment, JsxSelfClosingElement,
    JsxElement, JsxFlags, JsxClosingElement,
    JsxOpeningElement, JsxEmit, NewExpression,
    ElementAccessExpression, NodeArray, ClassElement,
    Decorator, Block, DeleteExpression,
    VoidExpression, AwaitExpression, PostfixUnaryExpression,
    ExpressionStatement, TypeLiteralNode, UnionOrIntersectionTypeNode,
    FunctionDeclaration, VariableStatement, DoStatement,
    WhileStatement, ForStatement, VariableDeclarationList,
    IterableOrIteratorType, WithStatement, SwitchStatement,
    CaseOrDefaultClause, CaseClause, LabeledStatement,
    ThrowStatement, TryStatement, BreakOrContinueStatement,
    ReturnStatement, EnumDeclaration, Statement,
    ModuleKind, ModuleBlock, Diagnostic,
    EnumMember, TypeReferenceSerializationKind, EmitResolver,
    ArrowFunction, HeritageClause
} from "./types";
import {
    Debug, objectAllocator, sum,
    forEach, createCompilerDiagnostic, hasProperty,
    map, concatenate, getDirectoryPath,
    contains, lookUp, forEachValue,
    rangeEquals, indexOf, filter,
    addRange, lastOrUndefined, Ternary,
    concatenateDiagnosticMessageChains, chainDiagnosticMessages, copyMap,
    memoize, createFileDiagnostic
} from "./core";
import {
    createDiagnosticCollection, createDiagnosticForNode, isFunctionLike,
    isExternalModule, getLocalSymbolForExportDefault, getSourceFileOfNode,
    getAncestor, isClassElement, isClassLike,
    getEnclosingBlockScopeContainer, declarationNameToString, isBlockOrCatchScoped,
    getDeclarationOfKind, isAliasSymbolDeclaration, isRightSideOfQualifiedNameOrPropertyAccess,
    nodeIsMissing, getExternalModuleImportEqualsDeclarationExpression, getResolvedModuleFileName,
    nodeIsPresent, isInternalModuleImportEqualsDeclaration, escapeIdentifier,
    isExternalModuleImportEqualsDeclaration, getTextOfNode, getSingleLineStringWriter,
    releaseStringWriter, isRestParameter, isBindingPattern,
    getCombinedNodeFlags, isInAmbientContext, getRootDeclaration,
    hasDynamicName, getSetAccessorTypeAnnotationNode, getClassExtendsHeritageClauseElement,
    getInterfaceBaseTypeNodes, hasQuestionToken, hasRestParameter,
    isSupportedExpressionWithTypeArguments, isObjectLiteralMethod, createDiagnosticForNodeFromMessageChain,
    getContainingFunction, nodeStartsNewLexicalEnvironment, getThisContainer,
    getContainingClass, getSuperContainer, isIntrinsicJsxName,
    getPropertyNameForKnownSymbolName, isWellKnownSymbolSyntactically, isAsyncFunctionLike,
    forEachYieldExpression, forEachReturnStatement, isPrologueDirective,
    getEntityNameFromTypeNode, nodeCanBeDecorated, getFirstConstructorWithBody,
    isFunctionBlock, isParameterDeclaration, getTextOfNodeFromSourceText,
    getClassImplementsHeritageClauseElements, isConst, isConstEnumDeclaration,
    isInstantiatedModule, getExternalModuleName, introducesArgumentsExoticObject,
    isDeclarationName, isExpression, isTypeNode,
    isDeclaration, isExpressionWithTypeArgumentsInClassExtendsClause, nodeIsSynthesized,
    getAllAccessorDeclarations, modifierToFlag, isLet,
    getSpanOfTokenAtPosition, textSpanEnd
} from "./utilities";
import {tokenToString, skipTrivia, getLineAndCharacterOfPosition} from "./scanner";
...
export const timings = {checkTime: 0};
...
export function createTypeChecker(host: TypeCheckerHost, produceDiagnostics: boolean): TypeChecker {
    ...
    function checkSourceFile(node: SourceFile) {
        ...
        timings.checkTime += new Date().getTime() - start;
    }
