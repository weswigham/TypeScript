/** @internal */
namespace ts {
    export function visibilityToString(flags: NodeFlags) {
    ...
    export function getQualifiedLeftMeaning(rightMeaning: SymbolFlags) {
        // If we are looking in value space, the parent meaning is value, other wise it is namespace
        return rightMeaning === SymbolFlags.Value ? SymbolFlags.Value : SymbolFlags.Namespace;
    }

    export function createGetSymbolDisplayBuilder(
        compilerOptions: CompilerOptions,
        languageVersion: ScriptTarget,
        emptyArray: any[],
        getTargetSymbol: (symbol: Symbol) => Symbol,
        getTypeParametersOfClassOrInterface: (symbol: Symbol) => TypeParameter[],
        getAccessibleSymbolChain: (symbol: Symbol, enclosingDeclaration: Node, meaning: SymbolFlags, useOnlyExternalAliasing: boolean) => Symbol[],
        needsQualification: (symbol: Symbol, enclosingDeclaration: Node, meaning: SymbolFlags) => boolean,
        getParentOfSymbol: (symbol: Symbol) => Symbol,
        getSymbolOfNode: (node: Node) => Symbol,
        getTypeAliasForTypeLiteral: (type: Type) => Symbol,
        resolveStructuredTypeMembers: (type: ObjectType) => ResolvedType,
        getTypeOfSymbol: (symbol: Symbol) => Type,
        getPropertiesOfObjectType: (type: Type) => Symbol[],
        getSignaturesOfType: (type: Type, kind: SignatureKind) => Signature[],
        getLocalTypeParametersOfClassOrInterfaceOrTypeAlias: (symbol: Symbol) => TypeParameter[],
        getConstraintOfTypeParameter: (typeParameter: TypeParameter) => Type,
        ...
        resolveBaseTypesOfClass: (type: InterfaceType) => void,
        ) {

        let booleanType: IntrinsicType & UnionType;
        let undefinedType: IntrinsicType;
        let nullType: IntrinsicType;
        let unknownType: IntrinsicType;
        let globalArrayType: Type;
        ...
        function onInitializeTypeChecker(booleanT: IntrinsicType & UnionType, undefinedT: IntrinsicType, nullT: IntrinsicType, unknownT: IntrinsicType, globalArrayT: Type) {
            booleanType = booleanT;
            undefinedType = undefinedT;
            nullType = nullT;
            unknownType = unknownT;
            globalArrayType = globalArrayT;
        }
