import {
    SourceFile, EmitResolver, EmitResult,
    ScriptTarget, SourceMapData, Diagnostic,
    JsxEmit, LanguageVariant, Node,
    TextRange, SymbolFlags, Map,
    Identifier, ExportDeclaration, ExportSpecifier,
    ImportDeclaration, ImportEqualsDeclaration, ExportAssignment,
    CharacterCodes, ModuleDeclaration, EnumDeclaration,
    SyntaxKind, LiteralExpression, SourceMapSpan,
    Declaration, CommentRange, NodeArray,
    TaggedTemplateExpression, TemplateExpression, BinaryExpression,
    Expression, CallExpression, TemplateSpan,
    JsxElement, JsxSelfClosingElement, QualifiedName,
    JsxAttribute, JsxOpeningLikeElement, JsxChild,
    JsxSpreadAttribute, JsxExpression, JsxText,
    JsxOpeningElement, JsxClosingElement, DeclarationName,
    ComputedPropertyName, BindingElement, EnumMember,
    ParameterDeclaration, PropertyAssignment, PropertyDeclaration,
    VariableDeclaration, ExpressionStatement, FunctionLikeDeclaration,
    NodeCheckFlags, ModuleKind, ImportSpecifier,
    BindingPattern, SpreadElementExpression, YieldExpression,
    AwaitExpression, ConditionalExpression, ArrayLiteralExpression,
    NodeFlags, ObjectLiteralExpression, AccessorDeclaration,
    ShorthandPropertyAssignment, MethodDeclaration, PropertyAccessExpression,
    ElementAccessExpression, LeftHandSideExpression, AssertionExpression,
    ParenthesizedExpression, EntityName, NewExpression,
    TypeAssertion, DeleteExpression, VoidExpression,
    TypeOfExpression, PrefixUnaryExpression, PostfixUnaryExpression,
    Block, IfStatement, DoStatement,
    WhileStatement, VariableDeclarationList, ForStatement,
    ForInStatement, ForOfStatement, BreakOrContinueStatement,
    ReturnStatement, WithStatement, SwitchStatement,
    CaseBlock, CaseClause, CaseOrDefaultClause,
    ThrowStatement, TryStatement, CatchClause,
    LabeledStatement, ClassDeclaration, VariableStatement,
    FunctionDeclaration, ConstructorDeclaration, ClassLikeDeclaration,
    ExpressionWithTypeArguments, ClassExpression, Decorator,
    TypeNode, ParenthesizedTypeNode, TypeReferenceNode,
    TypeReferenceSerializationKind, ArrayTypeNode, InterfaceDeclaration,
    ModuleBlock, NamespaceImport, NamedImports,
    ImportOrExportSpecifier, ArrowFunction, AsExpression
} from "./types";
import {
    isExternalModule, isDeclarationFile, EmitHost,
    shouldEmitToOwnFile, getOwnEmitOutputFilePath, createTextWriter,
    writeCommentRange, getExternalModuleName, escapeIdentifier,
    makeIdentifierFromModuleName, unescapeIdentifier, getTextOfNode,
    EmitTextWriter, escapeString, convertToBase64,
    writeFile, getSourceFilePathInNewDir, nodeIsSynthesized,
    createSynthesizedNode, isTemplateLiteralKind, getSourceTextOfNodeFromSourceFile,
    escapeNonAsciiCharacters, isExpression, isIntrinsicJsxName,
    nodeIsDecorated, isBindingPattern, isAssignmentOperator,
    getAllAccessorDeclarations, isLeftHandSideExpression, declarationNameToString,
    getCombinedNodeFlags, isFunctionLike, SynthesizedNode,
    isLet, isConst, getLineOfLocalPosition,
    createSynthesizedNodeArray, isEmptyObjectLiteralOrArrayLiteral, hasRestParameter,
    nodeIsMissing, getEntityNameFromTypeNode, isAsyncFunctionLike,
    getFirstConstructorWithBody, getClassExtendsHeritageClauseElement, nodeCanBeDecorated,
    nodeOrChildIsDecorated, isAccessor, getSetAccessorTypeAnnotationNode,
    isDeclaration, isTypeNode, cloneEntityName,
    nodeIsPresent, isInstantiatedModule, isAliasSymbolDeclaration,
    isExternalModuleImportEqualsDeclaration, isInternalModuleImportEqualsDeclaration, getEnclosingBlockScopeContainer,
    isPrologueDirective, getLeadingCommentRangesOfNode, emitNewLineBeforeLeadingComments,
    emitComments, fullTripleSlashReferencePathRegEx
} from "./utilities";
import {
    Debug, forEach, contains,
    hasProperty, sortAndDeduplicateDiagnostics, lastOrUndefined,
    getRelativePathToDirectoryOrUrl, getProperty, getBaseFileName,
    normalizeSlashes, directorySeparator, getDirectoryPath,
    isRootedDiskPath, isUrl, combinePaths, 
    normalizePath, Comparison, isEmpty,
    filter
} from "./core";
import {forEachChild} from "./parser";
import {getNodeId} from "./checker";
import {
    getLineAndCharacterOfPosition, skipTrivia, tokenToString,
    isWhiteSpace, isLineBreak, getLeadingCommentRanges,
    getTrailingCommentRanges, getShebang
} from "./scanner";
