import {
    DiagnosticMessage, SyntaxKind, ScriptTarget,
    LanguageVariant, Map, CharacterCodes,
    SourceFile, LineAndCharacter, CommentRange
} from "./types";
import {Debug, binarySearch, lastOrUndefined} from "./core";
