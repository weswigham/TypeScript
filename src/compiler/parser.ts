import {
    SyntaxKind, Node, QualifiedName,
    TypeParameterDeclaration, VariableLikeDeclaration, SignatureDeclaration,
    FunctionLikeDeclaration, ArrowFunction, TypeReferenceNode,
    TypePredicateNode, TypeLiteralNode, ArrayTypeNode,
    TypeQueryNode, TupleTypeNode, UnionOrIntersectionTypeNode,
    ParenthesizedTypeNode, PropertyAccessExpression, ElementAccessExpression,
    BindingPattern, ArrayLiteralExpression, ObjectLiteralExpression,
    CallExpression, TaggedTemplateExpression, TypeAssertion,
    ParenthesizedExpression, DeleteExpression, TypeOfExpression,
    VoidExpression, PrefixUnaryExpression, YieldExpression,
    AwaitExpression, PostfixUnaryExpression, BinaryExpression,
    AsExpression, ConditionalExpression, SpreadElementExpression,
    Block, SourceFile, VariableStatement,
    VariableDeclarationList, ExpressionStatement, IfStatement,
    ...
    CaseBlock, CaseClause, DefaultClause,
    LabeledStatement, ThrowStatement, TryStatement,
    CatchClause, Decorator, ClassLikeDeclaration,
    InterfaceDeclaration, ClassDeclaration,
    TypeAliasDeclaration, EnumDeclaration, EnumMember,
    ModuleDeclaration, ImportEqualsDeclaration, ImportDeclaration,
    ImportClause, NamespaceImport, NamedImportsOrExports,
    ExportDeclaration, ImportOrExportSpecifier, ExportAssignment,
    TemplateExpression, TemplateSpan, ComputedPropertyName,
    HeritageClause, ExpressionWithTypeArguments, ExternalModuleReference,
    JsxElement, JsxOpeningElement, JsxOpeningLikeElement,
    JsxAttribute, JsxSpreadAttribute, JsxExpression,
    JsxClosingElement, JSDocTypeExpression, JSDocUnionType,
    JSDocTupleType, JSDocArrayType, JSDocNonNullableType,
    JSDocNullableType, JSDocRecordType, JSDocTypeReference,
    JSDocOptionalType, JSDocFunctionType, JSDocVariadicType,
    JSDocConstructorType, JSDocThisType, JSDocRecordMember,
    JSDocComment, JSDocParameterTag, JSDocReturnTag,
    JSDocTypeTag, JSDocTemplateTag, ScriptTarget,
    TextChangeRange, ParserContextFlags, Diagnostic,
    Map, LanguageVariant, NodeFlags,
    DiagnosticMessage, Identifier, DeclarationName,
    LiteralExpression, NodeArray, MethodDeclaration,
    VariableDeclaration, ParameterDeclaration, EntityName,
    CharacterCodes, TypeNode, StringLiteral,
    ModifiersArray, IndexSignatureDeclaration, Declaration,
    PropertyDeclaration, FunctionOrConstructorTypeNode, Expression,
    PostfixExpression, LeftHandSideExpression, UnaryExpression,
    MemberExpression, PrimaryExpression, JsxSelfClosingElement,
    JsxText, JsxChild, AccessorDeclaration,
    ObjectLiteralElement, ShorthandPropertyAssignment, PropertyAssignment,
    FunctionExpression, NewExpression, Statement,
    IterationStatement, CaseOrDefaultClause, BindingElement,
    FunctionDeclaration, ConstructorDeclaration, ClassElement,
    SemicolonClassElement, ClassExpression, ModuleBlock,
    NamedImports, ImportSpecifier, FileReference,
    JSDocType, JSDocAllType, JSDocUnknownType,
    JSDocTag, TextRange
} from "./types";
import {
    Debug, objectAllocator, normalizePath,
    fileExtensionIs, lastOrUndefined, createFileDiagnostic,
    hasProperty, forEach, AssertionLevel
} from "./core";
import {
    isJavaScript, isTsx, getLeadingCommentRangesOfNode,
    escapeIdentifier, isModifier, nodeIsMissing,
    containsParseError, getFullWidth, isLeftHandSideExpression,
    isAssignmentOperator, getTextOfNodeFromSourceText, isKeyword,
    modifierToFlag, getFileReferenceFromReferencePath, textChangeRangeIsUnchanged,
    textSpanEnd, textChangeRangeNewSpan, createTextSpanFromBounds,
    createTextChangeRange, nodeIsPresent
} from "./utilities";
import {
    createScanner, skipTrivia, tokenToString,
    isOctalDigit, isLineBreak, isWhiteSpace,
    isIdentifierStart, isIdentifierPart
} from "./scanner";
import {Diagnostics} from "./diagnosticInformationMap.generated";

let nodeConstructors = new Array<new () => Node>(SyntaxKind.Count);
/* @internal */ export const timings = {parseTime: 0};
...
export function createSourceFile(fileName: string, sourceText: string, languageVersion: ScriptTarget, setParentNodes = false): SourceFile {
    ...
    timings.parseTime += new Date().getTime() - start;
    return result;
}
