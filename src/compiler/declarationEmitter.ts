import {
    SourceFile, SymbolAccessiblityResult, SymbolWriter,
    Diagnostic, DiagnosticMessage, DeclarationName,
    EmitResolver, NodeFlags, Node,
    TextRange, SyntaxKind, ImportDeclaration,
    CommentRange, SymbolAccessibility, Symbol,
    SymbolFlags, AccessorDeclaration, VariableLikeDeclaration,
    TypeNode, TypeFormatFlags, SignatureDeclaration,
    EntityName, Identifier, QualifiedName,
    ExpressionWithTypeArguments, TypeReferenceNode, TypeQueryNode,
    ArrayTypeNode, TupleTypeNode, UnionTypeNode,
    IntersectionTypeNode, ParenthesizedTypeNode, FunctionOrConstructorTypeNode,
    TypeLiteralNode, TypePredicateNode, Expression,
    PropertyAccessExpression, ExportAssignment, Declaration,
    FunctionLikeDeclaration, VariableStatement, InterfaceDeclaration,
    ClassDeclaration, TypeAliasDeclaration, EnumDeclaration,
    ModuleDeclaration, ImportEqualsDeclaration, NamespaceImport,
    NamedImports, ImportOrExportSpecifier, ExportSpecifier,
    ExportDeclaration, ModuleBlock, EnumMember,
    TypeParameterDeclaration, ConstructorDeclaration, VariableDeclaration,
    BindingPattern, BindingElement, ParameterDeclaration,
    PropertyDeclaration
} from "./types";
import {
    EmitHost, EmitTextWriter, getOwnEmitOutputFilePath,
    tryResolveScriptReference, shouldEmitToOwnFile,
    createTextWriter, createDiagnosticForNode, getSourceTextOfNodeFromSourceFile,
    getJsDocComments, emitNewLineBeforeLeadingComments, emitComments,
    writeCommentRange, isSupportedExpressionWithTypeArguments, isExternalModule,
    isInternalModuleImportEqualsDeclaration, getExternalModuleImportEqualsDeclarationExpression, isConst,
    getClassExtendsHeritageClauseElement, getClassImplementsHeritageClauseElements, getFirstConstructorWithBody,
    getInterfaceBaseTypeNodes, hasDynamicName, isBindingPattern,
    hasQuestionToken, isLet, getAllAccessorDeclarations,
    writeFile
} from "./utilities";
import {
    Debug, forEach, contains,
    hasProperty, removeFileExtension, getRelativePathToDirectoryOrUrl,
    getDirectoryPath, normalizeSlashes
} from "./core";
import {getLeadingCommentRanges} from "./scanner";
import {isExternalModuleOrDeclarationFile} from "./emitter";
