...
import {
    Node, SyntaxKind, NodeFlags,
    ModuleDeclaration, SourceFile, Map,
    SymbolFlags, Symbol, Declaration,
    LiteralExpression, ComputedPropertyName,
    Identifier, PropertyAccessExpression, SymbolTable,
    ExportAssignment, Block, SignatureDeclaration,
    ObjectLiteralExpression, BinaryExpression, CatchClause,
    DeleteExpression, FunctionLikeDeclaration, PostfixUnaryExpression,
    PrefixUnaryExpression, WithStatement, DiagnosticMessage,
    ModuleBlock, NodeArray, Statement,
    ExpressionStatement, ParameterDeclaration, VariableDeclaration,
    BindingElement, PropertyDeclaration, MethodDeclaration,
    FunctionDeclaration, TypeLiteralNode, FunctionExpression,
    ClassLikeDeclaration, EnumDeclaration, ImportClause,
    ExportDeclaration
} from "./types";
import {
    isConstEnumDeclaration, isWellKnownSymbolSyntactically, getPropertyNameForKnownSymbolName,
    declarationNameToString, hasDynamicName, createDiagnosticForNode,
    getCombinedNodeFlags, isFunctionLike, isExternalModule,
    getErrorSpanForNode, isIdentifierName, getContainingClass,
    isLeftHandSideExpression, isAssignmentOperator, getSpanOfTokenAtPosition,
    isPrologueDirective, getTextOfNodeFromSourceText, isObjectLiteralMethod,
    isConst, isBindingPattern, isBlockOrCatchScoped,
    isParameterDeclaration, isClassLike
} from "./utilities";
import {
    Debug, forEach, hasProperty,
    objectAllocator, createFileDiagnostic, indexOf,
    removeFileExtension
} from "./core";
import {Diagnostics} from "./diagnosticInformationMap.generated";


export const timings = { bindTime: 0 };
...
export function bindSourceFile(file: SourceFile) {
    ...
    timings.bindTime += new Date().getTime() - start;
}
