...
/* @internal */
export function getModuleInstanceState(node: ModuleDeclaration, visited?: ts.Map<ModuleInstanceState | undefined>): ModuleInstanceState {
...
/* @internal */
function getModuleInstanceStateWorker(node: Node, visited: ts.Map<ModuleInstanceState | undefined>): ModuleInstanceState {
...
/* @internal */
function getModuleInstanceStateForAliasTarget(specifier: ExportSpecifier, visited: ts.Map<ModuleInstanceState | undefined>) {
...
function createBinder(): (file: SourceFile, options: CompilerOptions) => void {
    ...
    function isLogicalExpression(node: Node) {
        while (true) {
            if (node.kind === SyntaxKind.ParenthesizedExpression) {
                ...
                return node.kind === SyntaxKind.BinaryExpression && ((<BinaryExpression>node).operatorToken.kind === SyntaxKind.AmpersandAmpersandToken ||
    ...
    function bindDynamicallyNamedThisPropertyAssignment(node: BinaryExpression | DynamicNamedDeclaration, symbol: ts.Symbol) {
