import { TransformationContext, getStrictOptionValue, getEmitScriptTarget, getEmitModuleKind, SyntaxKind, SourceFile, ModuleDeclaration, Identifier, Block, ModuleBlock, CaseBlock, ClassDeclaration, UnderscoreEscapedMap, Node, Bundle, createBundle, mapDefined, createUnparsedSourceFile, addEmitHelpers, hasModifier, ModifierFlags, FunctionDeclaration, Debug, isClassDeclaration, VisitResult, TransformFlags, ImportDeclaration, ImportEqualsDeclaration, ExportAssignment, ExportDeclaration, getParseTreeNode, visitEachChild, ConstructorDeclaration, PropertyDeclaration, modifierToFlag, isStatement, createNotEmittedStatement, ClassExpression, HeritageClause, ExpressionWithTypeArguments, MethodDeclaration, GetAccessorDeclaration, SetAccessorDeclaration, FunctionExpression, ArrowFunction, ParameterDeclaration, ParenthesizedExpression, AssertionExpression, CallExpression, NewExpression, TaggedTemplateExpression, NonNullExpression, EnumDeclaration, VariableStatement, VariableDeclaration, isExternalModule, ModuleKind, isJsonSourceFile, updateSourceFileNode, visitLexicalEnvironment, getFirstConstructorWithBody, forEach, some, getEffectiveBaseTypeNode, skipOuterExpressions, childIsDecorated, ClassLikeDeclaration, Statement, getProperties, getGeneratedNameForNode, createTokenRange, skipTrivia, getInternalName, createPartiallyEmittedExpression, setEmitFlags, EmitFlags, createReturn, insertStatementsAfterStandardPrologue, createImmediatelyInvokedArrowFunction, ScriptTarget, addSyntheticLeadingComment, createVariableStatement, createVariableDeclarationList, createVariableDeclaration, getLocalName, NodeFlags, setOriginalNode, setCommentRange, setSourceMapRange, moveRangePastDecorators, startOnNewLine, createExportDefault, createExternalModuleExport, createEndOfDeclarationMarker, getEmitFlags, singleOrMany, visitNodes, isModifier, createClassDeclaration, isHeritageClause, aggregateTransformFlags, setTextRange, createClassExpression, createAssignment, Expression, ClassElement, filter, isParameterPropertyDeclaration, isIdentifier, createProperty, addRange, isClassElement, createNodeArray, nodeOrChildIsDecorated, Decorator, FunctionLikeDeclaration, parameterIsThisKeyword, AccessorDeclaration, getAllAccessorDeclarations, Declaration, map, flatMap, createVoidZero, createNull, createExpressionStatement, getOriginalNodeId, visitNode, isExpression, ObjectLiteralElementLike, createPropertyAssignment, createArrowFunction, createToken, createObjectLiteral, BinaryExpression, PropertyAccessExpression, VoidExpression, ConditionalExpression, getSetAccessorTypeAnnotationNode, getEffectiveReturnTypeNode, createIdentifier, ArrayLiteralExpression, isClassLike, isFunctionLike, nodeIsPresent, getRestParameterElementType, createArrayLiteral, SignatureDeclaration, isAsyncFunction, TypeNode, ParenthesizedTypeNode, LiteralTypeNode, TypeReferenceNode, UnionOrIntersectionTypeNode, ConditionalTypeNode, TypeOperatorNode, TypeReferenceSerializationKind, findAncestor, isConditionalTypeNode, createTempVariable, createConditional, createTypeCheck, createLogicalAnd, createStrictInequality, createTypeOf, createLiteral, EntityName, createPropertyAccess, getMutableClone, QualifiedName, EnumMember, isPrivateIdentifier, isComputedPropertyName, isSimpleInlineableExpression, idText, getSynthesizedClone, PropertyName, hasStaticModifier, skipPartiallyEmittedExpressions, updateComputedPropertyName, isPropertyName, updateExpressionWithTypeArguments, isLeftHandSideExpression, nodeIsMissing, updateProperty, updateConstructor, visitParameterList, visitFunctionBody, addPrologueDirectivesAndInitialSuperCall, mergeLexicalEnvironment, createBlock, ParameterPropertyDeclaration, removeAllComments, createThis, moveRangePos, updateMethod, updateGetAccessor, updateSetAccessor, updateFunctionDeclaration, createOmittedExpression, updateFunctionExpression, updateArrowFunction, updateParameter, isBindingName, moveRangePastModifiers, getInitializedVariables, inlineExpressions, isBindingPattern, flattenDestructuringAssignment, FlattenLevel, updateTypeScriptVariableDeclaration, OuterExpressionKinds, isAssertionExpression, length, getLeadingCommentRangesOfNode, updateParen, updateCall, updateNew, updateTaggedTemplate, isEnumConst, getExternalModuleOrNamespaceExportName, createLogicalOr, createCall, createFunctionExpression, createParameter, setSyntheticLeadingComments, setSyntheticTrailingComments, addEmitFlags, createElementAccess, isModuleDeclaration, isInstantiatedModule, createUnderscoreEscapedMap, __String, createMergeDeclarationMarker, TextRange, isArray, isImportClause, ImportsNotUsedAsValues, updateImportDeclaration, ImportClause, isNamedImportBindings, updateImportClause, NamedImportBindings, isImportSpecifier, updateNamedImports, ImportSpecifier, isNamedExportBindings, updateExportDeclaration, NamedExports, isExportSpecifier, updateNamedExports, NamespaceExport, updateNamespaceExport, NamedExportBindings, isNamespaceExport, ExportSpecifier, isExternalModuleImportEqualsDeclaration, createImportDeclaration, createExpressionFromEntityName, createRange, getNamespaceMemberName, NodeCheckFlags, createUniqueName, isGeneratedIdentifier, getDeclarationName, getOriginalNode, EmitHint, isSourceFile, isShorthandPropertyAssignment, ShorthandPropertyAssignment, ElementAccessExpression, isLocalName, LeftHandSideExpression, setConstantValue, isAccessExpression, isPropertyAccessExpression, declarationNameToString, getTextOfNode, addSyntheticTrailingComment, isElementAccessExpression, getUnscopedHelperName, UnscopedEmitHelper } from "../ts";
/*@internal*/
/**
...
export function transformTypeScript(context: TransformationContext) {
    ...
    function visitClassDeclaration(node: ClassDeclaration): VisitResult<Statement> {
        ...
        if (facts & ClassFacts.UseImmediatelyInvokedFunctionExpression) {
            ...
            /*modifiers*/ undefined, createVariableDeclarationList([
                createVariableDeclaration(getLocalName(node, /*allowComments*/ false, /*allowSourceMaps*/ false), 
                /*type*/ undefined, iife)
    ...
    function createClassDeclarationHeadWithDecorators(node: ClassDeclaration, name: Identifier | undefined) {
        ...
        /*modifiers*/ undefined, createVariableDeclarationList([
            createVariableDeclaration(declName, 
            /*type*/ undefined, classAlias ? createAssignment(classAlias, classExpression) : classExpression)
        ], NodeFlags.Let));
    ...
    function visitExpressionWithTypeArguments(node: ExpressionWithTypeArguments): ExpressionWithTypeArguments {
        ...
        /*typeArguments*/ undefined, visitNode(node.expression, visitor, isLeftHandSideExpression));
    }
    /**
     ...
     * @param node The declaration node.
     */
    function shouldEmitFunctionLikeDeclaration<T extends FunctionLikeDeclaration>(node: T): node is T & {
    ...
    function visitPropertyDeclaration(node: PropertyDeclaration) {
        ...
        const updated = updateProperty(node, 
        /*decorators*/ undefined, visitNodes(node.modifiers, visitor, isModifier), visitPropertyNameOfClassElement(node), 
        /*questionOrExclamationToken*/ undefined, 
        /*type*/ undefined, visitNode(node.initializer, visitor));
        if (updated !== node) {
    ...
    function visitMethodDeclaration(node: MethodDeclaration) {
        ...
        const updated = updateMethod(node, 
        /*decorators*/ undefined, visitNodes(node.modifiers, modifierVisitor, isModifier), node.asteriskToken, visitPropertyNameOfClassElement(node), 
    ...
    function visitGetAccessor(node: GetAccessorDeclaration) {
        ...
        const updated = updateGetAccessor(node, 
        /*decorators*/ undefined, visitNodes(node.modifiers, modifierVisitor, isModifier), visitPropertyNameOfClassElement(node), visitParameterList(node.parameters, visitor, context), 
        /*type*/ undefined, visitFunctionBody(node.body, visitor, context) || createBlock([]));
        if (updated !== node) {
            // While we emit the source map for the node after skipping decorators and modifiers,
            // we need to emit the comments for the original range.
            setCommentRange(updated, node);
    ...
    function visitSetAccessor(node: SetAccessorDeclaration) {
        ...
        const updated = updateSetAccessor(node, 
        /*decorators*/ undefined, visitNodes(node.modifiers, modifierVisitor, isModifier), visitPropertyNameOfClassElement(node), visitParameterList(node.parameters, visitor, context), visitFunctionBody(node.body, visitor, context) || createBlock([]));
        if (updated !== node) {
            // While we emit the source map for the node after skipping decorators and modifiers,
            // we need to emit the comments for the original range.
            setCommentRange(updated, node);
    ...
    function visitFunctionDeclaration(node: FunctionDeclaration): VisitResult<Statement> {
        ...
        const updated = updateFunctionDeclaration(node, 
        /*decorators*/ undefined, visitNodes(node.modifiers, modifierVisitor, isModifier), node.asteriskToken, node.name, 
        /*typeParameters*/ undefined, visitParameterList(node.parameters, visitor, context), 
        /*type*/ undefined, visitFunctionBody(node.body, visitor, context) || createBlock([]));
        if (isExportOfNamespace(node)) {
    ...
    function visitFunctionExpression(node: FunctionExpression): Expression {
        ...
        const updated = updateFunctionExpression(node, visitNodes(node.modifiers, modifierVisitor, isModifier), node.asteriskToken, node.name, 
        /*typeParameters*/ undefined, visitParameterList(node.parameters, visitor, context), 
        /*type*/ undefined, visitFunctionBody(node.body, visitor, context) || createBlock([]));
        return updated;
    }
    function visitArrowFunction(node: ArrowFunction) {
        const updated = updateArrowFunction(node, visitNodes(node.modifiers, modifierVisitor, isModifier), 
        /*typeParameters*/ undefined, visitParameterList(node.parameters, visitor, context), 
    ...
    function visitParameter(node: ParameterDeclaration) {
        ...
        const updated = updateParameter(node, 
        /*decorators*/ undefined, 
    ...
    function transformInitializedVariable(node: VariableDeclaration): Expression {
        ...
        if (isBindingPattern(name)) {
            ...
            return setTextRange(createAssignment(getNamespaceMemberNameWithSourceMapsAndWithoutComments(name), visitNode(node.initializer, visitor, isExpression)), 
            /*location*/ node);
        }
    }
    function visitVariableDeclaration(node: VariableDeclaration) {
        return updateTypeScriptVariableDeclaration(node, visitNode(node.name, visitor, isBindingName), 
    ...
    function visitCallExpression(node: CallExpression) {
        return updateCall(node, visitNode(node.expression, visitor, isExpression), 
    ...
    function visitTaggedTemplateExpression(node: TaggedTemplateExpression) {
        return updateTaggedTemplate(node, visitNode(node.tag, visitor, isExpression), 
        /*typeArguments*/ undefined, visitNode(node.template, visitor, isExpression));
    }
    /**
    ...
    function transformEnumBody(node: EnumDeclaration, localName: Identifier): Block {
        ...
        return createBlock(setTextRange(createNodeArray(statements), /*location*/ node.members), 
        /*multiLine*/ true);
    }
    /**
    ...
    function addVarForEnumOrModuleDeclaration(statements: Statement[], node: ModuleDeclaration | EnumDeclaration) {
        ...
        const statement = createVariableStatement(visitNodes(node.modifiers, modifierVisitor, isModifier), createVariableDeclarationList([
    ...
    function visitModuleDeclaration(node: ModuleDeclaration): VisitResult<Statement> {
        ...
        //      x_1.y = ...;
        //  })(x || (x = {}));
        const moduleStatement = createExpressionStatement(createCall(createFunctionExpression(
        /*modifiers*/ undefined, 
        /*asteriskToken*/ undefined, 
        /*name*/ undefined, 
        /*typeParameters*/ undefined, [createParameter(/*decorators*/ undefined, /*modifiers*/ undefined, /*dotDotDotToken*/ undefined, parameterName)], 
    ...
    function transformModuleBody(node: ModuleDeclaration, namespaceLocalName: Identifier): Block {
        ...
        currentScopeFirstDeclarationsOfName = savedCurrentScopeFirstDeclarationsOfName;
        const block = createBlock(setTextRange(createNodeArray(statements), 
    ...
    function visitImportEqualsDeclaration(node: ImportEqualsDeclaration): VisitResult<Statement> {
        if (isExternalModuleImportEqualsDeclaration(node)) {
            ...
            if (!isReferenced && compilerOptions.importsNotUsedAsValues === ImportsNotUsedAsValues.Preserve) {
                return setOriginalNode(setTextRange(createImportDeclaration(
                /*decorators*/ undefined, 
                /*modifiers*/ undefined, 
        ...
        if (isNamedExternalModuleExport(node) || !isExportOfNamespace(node)) {
            ...
            return setOriginalNode(setTextRange(createVariableStatement(visitNodes(node.modifiers, modifierVisitor, isModifier), createVariableDeclarationList([
                setOriginalNode(createVariableDeclaration(node.name, 
    ...
    function trySubstituteNamespaceExportedName(node: Identifier): Expression | undefined {
        ...
        if (enabledSubstitutions & applicableSubstitutions && !isGeneratedIdentifier(node) && !isLocalName(node)) {
            ...
            if (container && container.kind !== SyntaxKind.SourceFile) {
                ...
                if (substitute) {
                    return setTextRange(createPropertyAccess(getGeneratedNameForNode(container), node), 
                    /*location*/ node);
                }
            }
        }
...
function createDecorateHelper(context: TransformationContext, decoratorExpressions: Expression[], target: Expression, memberName?: Expression, descriptor?: Expression, location?: TextRange) {
    ...
    return setTextRange(createCall(getUnscopedHelperName("__decorate"), 
...
function createMetadataHelper(context: TransformationContext, metadataKey: string, metadataValue: Expression) {
    ...
    return createCall(getUnscopedHelperName("__metadata"), 
...
function createParamHelper(context: TransformationContext, expression: Expression, parameterOffset: number, location?: TextRange) {
    ...
    return setTextRange(createCall(getUnscopedHelperName("__param"), 
    /*typeArguments*/ undefined, [
