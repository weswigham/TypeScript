import { TransformationContext, Expression, ParameterDeclaration, ModuleKind, SourceFile, getEmitScriptTarget, getEmitModuleKind, SyntaxKind, ExternalModuleInfo, Statement, chainBundle, isEffectiveExternalModule, TransformFlags, isJsonSourceFile, hasJsonModuleEmitEnabled, collectExternalModuleInfo, getOriginalNodeId, aggregateTransformFlags, isExternalModule, getStrictOptionValue, addPrologue, append, visitNode, isStatement, addRange, visitNodes, insertStatementsAfterStandardPrologue, updateSourceFileNode, setTextRange, createNodeArray, addEmitHelpers, createIdentifier, tryGetModuleNameFromFile, createExpressionStatement, createCall, createArrayLiteral, emptyArray, createLiteral, createObjectLiteral, createFunctionExpression, createParameter, createBlock, createIf, createLogicalAnd, createTypeCheck, createPropertyAccess, createVariableStatement, createVariableDeclaration, setEmitFlags, createStrictInequality, createAssignment, EmitFlags, getExternalModuleNameLiteral, getLocalNameForExternalImport, ImportDeclaration, ExportDeclaration, ImportEqualsDeclaration, isImportEqualsDeclaration, isExportDeclaration, mapDefined, addEmitHelper, createReturn, Node, VisitResult, ExportAssignment, VariableStatement, FunctionDeclaration, ClassDeclaration, MergeDeclarationMarker, EndOfDeclarationMarker, visitEachChild, isImportCall, isDestructuringAssignment, isObjectLiteralExpression, Debug, isArrayLiteralExpression, isSpreadElement, isIdentifier, length, isExportName, DestructuringAssignment, flattenDestructuringAssignment, FlattenLevel, ImportCall, firstOrUndefined, isSimpleCopiableExpression, isGeneratedIdentifier, isStringLiteral, getSynthesizedClone, createConditional, createTempVariable, createComma, createUniqueName, createOmittedExpression, FunctionExpression, ArrowFunction, ScriptTarget, createArrowFunction, createNew, getUnscopedHelperName, getEmitFlags, getExportNeedsImportStarHelper, getImportNeedsImportStarHelper, getImportNeedsImportDefaultHelper, getNamespaceDeclarationNode, setOriginalNode, VariableDeclaration, isDefaultImport, getGeneratedNameForNode, createVariableDeclarationList, NodeFlags, singleOrMany, isExternalModuleImportEqualsDeclaration, hasModifier, ModifierFlags, getExportName, getLocalName, isNamedExports, idText, createFunctionDeclaration, isModifier, getDeclarationName, createClassDeclaration, NodeArray, Modifier, isLocalName, updateVariableStatement, updateVariableDeclarationList, inlineExpressions, Identifier, TextRange, isBindingPattern, createVoidZero, BindingElement, isOmittedExpression, Declaration, createPropertyAssignment, startOnNewLine, EmitHint, isShorthandPropertyAssignment, ShorthandPropertyAssignment, ObjectLiteralElementLike, BinaryExpression, PrefixUnaryExpression, PostfixUnaryExpression, getExternalHelpersModuleName, isImportClause, isImportSpecifier, isAssignmentOperator, isDeclarationNameOfEnumOrNamespace, getNodeId, createBinary, createToken, UnscopedEmitHelper, EmitHelper } from "../../ts";
/*@internal*/
